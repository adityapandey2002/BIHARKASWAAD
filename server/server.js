...
// Trust proxy — required when running behind Hostinger's reverse proxy / Nginx
...
const allowedOrigins = [
  'http://localhost:3000',
  'http://localhost:5000',
  'https://biharkaswaad.com',
  'https://www.biharkaswaad.com',
...
// In production, the built React app is served from server/public/
// Run: npm run build (from root) to generate this
...
if (process.env.NODE_ENV === 'production') {
  ...
  // Development: helpful 404 for unmatched API routes
  app.use((req, res) => {
